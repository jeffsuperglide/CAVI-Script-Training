"""
Post processing assumes the Fpart from the active run.
Each location and location's parameter is exported with
the active run's Fpart and additional 'version' in the list.

The datetime_excel method is a Python generator converting
a list of HEC times to an Excel float.
"""
import csv
import itertools
import os
...
location = ["ASHLAND", "GRAYSONKY", "LEON"]    # B part
